 ...
 *
 *
 * @source $URL: https://svn.osgeo.org/geotools/branches/2.7.x/modules/unsupported/ogr/src/test/java/org/geotools/data/ogr/TestCaseSupport.java $
 * @version $Id: TestCaseSupport.java 37307 2011-05-25 06:34:11Z mbedward $
...
public abstract class TestCaseSupport extends TestCase {
    ...
    protected File getTempFile() throws IOException {
        return getTempFile("test-shp", ".shp");
    }

    protected File getTempFile(String fileName, String fileExt) throws IOException {
        File tmpFile = File.createTempFile(fileName, fileExt);
        assertTrue(tmpFile.isFile());
        
        // keep track of all temp files so we can delete them
        // FIXME markTempFile(tmpFile);
