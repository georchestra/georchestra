...
<c:choose>
    ...
    <div id="go_head">
        ...
        <iframe src="/header/?active=ldapadmin" style="width:100%;height:@shared.header.height@px;border:none;overflow:none;" scrolling="no" onload="_headerOnLoad(this)"></iframe>
    </div>
    </c:when>
</c:choose>
