...
<c:choose>
    ...
    <div id="go_head">
        ...
        <iframe src="/static/?lang=<%= lang %>&active=extractorapp" style="width:100%;height:@shared.header.height@px;border:none;overflow:none;" scrolling="no" frameborder="0" onload="_headerOnLoad(this)"></iframe>
    </div>
