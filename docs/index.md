...
Have a look at the [version numbering scheme](developer_guide/version_number.md) and the [release notes](https://github.com/georchestra/georchestra/releases) for more information.
