...
It features a **metadata catalog** (GeoNetwork 3.4), an **OGC server** (GeoServer 2.15) with fine-grained access control (based on GeoFence), an **advanced viewer and editor**, an **extractor** and **many more** (security and auth system based on proxy/CAS/LDAP, analytics, admin UIs, ...)
