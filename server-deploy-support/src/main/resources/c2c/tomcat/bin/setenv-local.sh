...
export ADD_JAVA_OPTS="-DCUSTOM_EPSG_FILE=file://$CATALINA_BASE/conf/epsg.properties -Dorg.geotools.referencing.forceXY=true -Dgeobretagne_production=true -Dextractor.storage.dir=$EXTRACTOR_DIR"
