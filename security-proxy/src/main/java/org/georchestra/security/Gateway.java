 ...
 * contents of WEB-INF/gateway.html to the user. The gateway.html page has an
 * iframe that attempts to load testPage?login. The testPage is restricted to
 * logged in users so it forces a redirect to cas. If the user has logged in
