...
/**
 * This class is used to check availability of several services of geOrchestra
 * stack
 *
 ...
 * /services_monitoring
 *
 * This page display status of services and global http code can be tested. If
 * /services_monitoring respond with HTTP 200 Code then services should be OK
 * otherwise this page will return a HTTP 500 code with description of services
 * not available.
 *
 */
...
public class ServicesMonitoring {
	...
	private String writeFailure(String service, Exception e) {
		return "<div class=\"fail\">" + service + " FAIL : " + e.getClass().getName() + ": " + e.getMessage()
				+ "</div>";
	}
