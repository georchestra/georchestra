...
//
// ============================================================================ 
package drebretagne_geobretagne.tpoint_id_0_1;
...
public class tpoint_id {
	...
	private final String jobName = "tpoint_id";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(tpoint_id.this, new Object[] { e,
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread
						...
						+ " présente des erreurs pour l'objet TPOINT_id", "");
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				org.geotools.data.edigeo.EdigeoDataStore store_sEdigeoInput_1_PG = new org.geotools.data.edigeo.EdigeoDataStore(
						context.edigeoDir + "/" + context.fileName, "TPOINT_id");
	...
	public static void main(String[] args) {
		final tpoint_id tpoint_idClass = new tpoint_id();

		int exitCode = tpoint_idClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = tpoint_id.class
					.getClassLoader()
					.getResourceAsStream(
							"drebretagne_geobretagne/tpoint_id_0_1/contexts/Default.properties");
			if (inContext != null) {
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = tpoint_id.class.getClassLoader()
						.getResourceAsStream(
								"drebretagne_geobretagne/tpoint_id_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : tpoint_id");
		}
...
/************************************************************************************************
 * 53320 characters generated by Spatial Data Integrator Powered by Talend on
