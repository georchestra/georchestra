...
//
// ============================================================================ 
package drebretagne_geobretagne.borne_id_0_1;
...
public class borne_id {
	...
	private final String jobName = "borne_id";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(borne_id.this, new Object[] { e,
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "", Thread
						.currentThread().getId()
						+ "", "INFO", "",
						"Beggining section object export in shp", "");
	...
	public static class row_sShapefileOutput_1_FIStruct implements
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime
						* result
						+ ((this.TEX2_id == null) ? 0 : this.TEX2_id.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.TEX2_id == null) {
				if (other.TEX2_id != null)
					return false;
			} else if (!this.TEX2_id.equals(other.TEX2_id))
				return false;
		...
		public int compareTo(row_sShapefileOutput_1_FIStruct other) {
			...
			returnValue = checkNullsAndCompare(this.TEX2_id, other.TEX2_id);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void sEdigeoInput_1_PGProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				map_sShapefileOutput_1_SO.put("TEX2_id", 1);
				attBuilder_sShapefileOutput_1_SO = new org.geotools.feature.AttributeTypeBuilder();
				...
				map_sShapefileOutput_1_SO.put("IDU_id", 2);
	...
	public static void main(String[] args) {
		final borne_id borne_idClass = new borne_id();

		int exitCode = borne_idClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = borne_id.class
					.getClassLoader()
					.getResourceAsStream(
							"drebretagne_geobretagne/borne_id_0_1/contexts/Default.properties");
			if (inContext != null) {
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = borne_id.class.getClassLoader()
						.getResourceAsStream(
								"drebretagne_geobretagne/borne_id_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : borne_id");
		}
...
/************************************************************************************************
 * 56000 characters generated by Spatial Data Integrator Powered by Talend on
 * the January 26, 2010 5:28:48 PM CET
 ************************************************************************************************/
