...
//
// ============================================================================ 
package drebretagne_geobretagne.ptcanv_id_0_1;
...
public class ptcanv_id {
	...
	private final String jobName = "ptcanv_id";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ptcanv_id.this, new Object[] { e,
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread
						...
						+ " présente des erreurs pour l'objet PTCANV_id", "");
	...
	public static class row_sShapefileOutput_1_FIStruct implements
		...
		public String PPLN_id;

		public String getPPLN_id() {
			return this.PPLN_id;
		}

		public String PALT_id;

		public String getPALT_id() {
			return this.PALT_id;
		}
			...
			synchronized (commonByteArrayLock) {
				...
				try {
					...
					if (length == -1) {
						...
						this.PPLN_id = new String(commonByteArray, 0, length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.PALT_id = new String(commonByteArray, 0, length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.CAN_id = new String(commonByteArray, 0, length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.MAP_id = new String(commonByteArray, 0, length);
					}
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.PPLN_id == null) {
					dos.writeInt(-1);
				} else {
					byte[] byteArray = this.PPLN_id.getBytes();
				...
				if (this.PALT_id == null) {
					dos.writeInt(-1);
				} else {
					byte[] byteArray = this.PALT_id.getBytes();
					dos.writeInt(byteArray.length);
					dos.write(byteArray);
				}
				...
				if (this.CAN_id == null) {
					...
					byte[] byteArray = this.CAN_id.getBytes();
					dos.writeInt(byteArray.length);
					dos.write(byteArray);
				}
				...
				if (this.MAP_id == null) {
					...
					byte[] byteArray = this.MAP_id.getBytes();
					dos.writeInt(byteArray.length);
					dos.write(byteArray);
				}
		...
		public String toString() {
			...
			sb.append("PPLN_id");
			sb.append("=");
			sb.append(String.valueOf(this.PPLN_id));

			sb.append(", ");

			sb.append("PALT_id");
			sb.append("=");
			sb.append(String.valueOf(this.PALT_id));
			...
			sb.append("CAN_id");
			sb.append("=");
			sb.append(String.valueOf(this.CAN_id));

			sb.append(", ");

			sb.append("MAP_id");
			sb.append("=");
			sb.append(String.valueOf(this.MAP_id));
	...
	public void sEdigeoInput_1_PGProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				attBuilder_sShapefileOutput_1_SO.setName("PPLN_id");
				...
				ftBuilder_sShapefileOutput_1_SO
						.add(attBuilder_sShapefileOutput_1_SO.buildDescriptor(
								"PPLN_id", attBuilder_sShapefileOutput_1_SO
										.buildType()));

				map_sShapefileOutput_1_SO.put("PPLN_id", 1);
				attBuilder_sShapefileOutput_1_SO = new org.geotools.feature.AttributeTypeBuilder();
				attBuilder_sShapefileOutput_1_SO.setName("PALT_id");
				attBuilder_sShapefileOutput_1_SO.setBinding(String.class);
				attBuilder_sShapefileOutput_1_SO.setNillable(true);

				ftBuilder_sShapefileOutput_1_SO
						.add(attBuilder_sShapefileOutput_1_SO.buildDescriptor(
								"PALT_id", attBuilder_sShapefileOutput_1_SO
										.buildType()));

				map_sShapefileOutput_1_SO.put("PALT_id", 2);
				attBuilder_sShapefileOutput_1_SO = new org.geotools.feature.AttributeTypeBuilder();
				...
				map_sShapefileOutput_1_SO.put("SYM_id", 3);
				attBuilder_sShapefileOutput_1_SO = new org.geotools.feature.AttributeTypeBuilder();
				attBuilder_sShapefileOutput_1_SO.setName("CAN_id");
				attBuilder_sShapefileOutput_1_SO.setBinding(String.class);
				attBuilder_sShapefileOutput_1_SO.setNillable(true);

				ftBuilder_sShapefileOutput_1_SO
						.add(attBuilder_sShapefileOutput_1_SO.buildDescriptor(
								"CAN_id", attBuilder_sShapefileOutput_1_SO
										.buildType()));

				map_sShapefileOutput_1_SO.put("CAN_id", 4);
				attBuilder_sShapefileOutput_1_SO = new org.geotools.feature.AttributeTypeBuilder();
				attBuilder_sShapefileOutput_1_SO.setName("MAP_id");
				attBuilder_sShapefileOutput_1_SO.setBinding(String.class);
				attBuilder_sShapefileOutput_1_SO.setNillable(true);

				ftBuilder_sShapefileOutput_1_SO
						.add(attBuilder_sShapefileOutput_1_SO.buildDescriptor(
								"MAP_id", attBuilder_sShapefileOutput_1_SO
										.buildType()));

				map_sShapefileOutput_1_SO.put("MAP_id", 5);
				attBuilder_sShapefileOutput_1_SO = new org.geotools.feature.AttributeTypeBuilder();
				...
				map_sShapefileOutput_1_SO.put("IDU_id", 6);
				...
				org.geotools.data.edigeo.EdigeoDataStore store_sEdigeoInput_1_PG = new org.geotools.data.edigeo.EdigeoDataStore(
						context.edigeoDir + "/" + context.fileName, "PTCANV_id");
				...
				while (reader_sEdigeoInput_1_PG.hasNext()) {
					org.opengis.feature.simple.SimpleFeature feature_sEdigeoInput_1_PG = reader_sEdigeoInput_1_PG
							.next();
					if (map_sEdigeoInput_1_PG.get("PPLN_id") != null) {
						row_sEdigeoInput_1_PG.PPLN_id = (String) feature_sEdigeoInput_1_PG
								.getAttribute(map_sEdigeoInput_1_PG
										.get("PPLN_id"));
					}
					if (map_sEdigeoInput_1_PG.get("PALT_id") != null) {
						row_sEdigeoInput_1_PG.PALT_id = (String) feature_sEdigeoInput_1_PG
								.getAttribute(map_sEdigeoInput_1_PG
										.get("PALT_id"));
					}
					...
					if (map_sEdigeoInput_1_PG.get("CAN_id") != null) {
						row_sEdigeoInput_1_PG.CAN_id = (String) feature_sEdigeoInput_1_PG
								.getAttribute(map_sEdigeoInput_1_PG
										.get("CAN_id"));
					}
					if (map_sEdigeoInput_1_PG.get("MAP_id") != null) {
						row_sEdigeoInput_1_PG.MAP_id = (String) feature_sEdigeoInput_1_PG
								.getAttribute(map_sEdigeoInput_1_PG
										.get("MAP_id"));
					}
					...
					row2.PPLN_id = row_sEdigeoInput_1_PG.PPLN_id;

					row2.PALT_id = row_sEdigeoInput_1_PG.PALT_id;

					row2.SYM_id = row_sEdigeoInput_1_PG.SYM_id;

					row2.CAN_id = row_sEdigeoInput_1_PG.CAN_id;

					row2.MAP_id = row_sEdigeoInput_1_PG.MAP_id;
					...
					{ // start of Var scope
						...
						copyOfexport_tmp.PPLN_id = row2.PPLN_id;
						copyOfexport_tmp.PALT_id = row2.PALT_id;
						copyOfexport_tmp.SYM_id = row2.SYM_id;
						copyOfexport_tmp.CAN_id = row2.CAN_id;
						copyOfexport_tmp.MAP_id = row2.MAP_id;
					...
					if (copyOfexport != null) {
						...
						row_sShapefileOutput_1_FI.PPLN_id = copyOfexport.PPLN_id;

						row_sShapefileOutput_1_FI.PALT_id = copyOfexport.PALT_id;

						row_sShapefileOutput_1_FI.SYM_id = copyOfexport.SYM_id;

						row_sShapefileOutput_1_FI.CAN_id = copyOfexport.CAN_id;

						row_sShapefileOutput_1_FI.MAP_id = copyOfexport.MAP_id;
						...
						outFeature_sShapefileOutput_1_SO.setAttribute(
								map_sShapefileOutput_1_SO.get("PPLN_id"),
								row_sShapefileOutput_1_FI.PPLN_id);

						outFeature_sShapefileOutput_1_SO.setAttribute(
								map_sShapefileOutput_1_SO.get("PALT_id"),
								row_sShapefileOutput_1_FI.PALT_id);
						...
						outFeature_sShapefileOutput_1_SO.setAttribute(
								map_sShapefileOutput_1_SO.get("CAN_id"),
								row_sShapefileOutput_1_FI.CAN_id);

						outFeature_sShapefileOutput_1_SO.setAttribute(
								map_sShapefileOutput_1_SO.get("MAP_id"),
								row_sShapefileOutput_1_FI.MAP_id);
	...
	public static void main(String[] args) {
		final ptcanv_id ptcanv_idClass = new ptcanv_id();

		int exitCode = ptcanv_idClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = ptcanv_id.class
					.getClassLoader()
					.getResourceAsStream(
							"drebretagne_geobretagne/ptcanv_id_0_1/contexts/Default.properties");
			if (inContext != null) {
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = ptcanv_id.class.getClassLoader()
						.getResourceAsStream(
								"drebretagne_geobretagne/ptcanv_id_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : ptcanv_id");
		}
...
/************************************************************************************************
 * 71406 characters generated by Spatial Data Integrator Powered by Talend on
