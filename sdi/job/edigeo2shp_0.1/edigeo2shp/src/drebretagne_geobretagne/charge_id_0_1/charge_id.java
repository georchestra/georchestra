...
//
// ============================================================================ 
package drebretagne_geobretagne.charge_id_0_1;
...
public class charge_id {
	...
	private final String jobName = "charge_id";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(charge_id.this, new Object[] { e,
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread
						...
						+ " présente des erreurs pour l'objet CHARGE_id", "");
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				org.geotools.data.edigeo.EdigeoDataStore store_sEdigeoInput_1_PG = new org.geotools.data.edigeo.EdigeoDataStore(
						context.edigeoDir + "/" + context.fileName, "CHARGE_id");
	...
	public static void main(String[] args) {
		final charge_id charge_idClass = new charge_id();

		int exitCode = charge_idClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = charge_id.class
					.getClassLoader()
					.getResourceAsStream(
							"drebretagne_geobretagne/charge_id_0_1/contexts/Default.properties");
			if (inContext != null) {
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = charge_id.class.getClassLoader()
						.getResourceAsStream(
								"drebretagne_geobretagne/charge_id_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : charge_id");
		}
...
/************************************************************************************************
 * 48448 characters generated by Spatial Data Integrator Powered by Talend on
