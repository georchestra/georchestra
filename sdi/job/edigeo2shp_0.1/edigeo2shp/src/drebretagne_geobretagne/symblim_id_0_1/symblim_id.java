...
//
// ============================================================================ 
package drebretagne_geobretagne.symblim_id_0_1;
...
public class symblim_id {
	...
	private final String jobName = "symblim_id";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(symblim_id.this, new Object[] { e,
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_2", "", Thread
						.currentThread().getId()
						+ "", "INFO", "",
						"Beggining symblim object export in shp", "");
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread
						...
						+ " présente des erreurs pour l'objet SYMBLIM_id", "");
	...
	public static class row_sShapefileOutput_1_FIStruct implements
		...
		public Double ORI_id;

		public Double getORI_id() {
			return this.ORI_id;
		}
		...
		public String toString() {
			...
			sb.append("ORI_id");
			sb.append("=");
			sb.append(String.valueOf(this.ORI_id));
	...
	public void sEdigeoInput_1_PGProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				attBuilder_sShapefileOutput_1_SO.setName("ORI_id");
				...
				ftBuilder_sShapefileOutput_1_SO
						.add(attBuilder_sShapefileOutput_1_SO.buildDescriptor(
								"ORI_id", attBuilder_sShapefileOutput_1_SO
										.buildType()));

				map_sShapefileOutput_1_SO.put("ORI_id", 1);
				attBuilder_sShapefileOutput_1_SO = new org.geotools.feature.AttributeTypeBuilder();
				...
				while (reader_sEdigeoInput_1_PG.hasNext()) {
					org.opengis.feature.simple.SimpleFeature feature_sEdigeoInput_1_PG = reader_sEdigeoInput_1_PG
							.next();
					if (map_sEdigeoInput_1_PG.get("ORI_id") != null) {
						row_sEdigeoInput_1_PG.ORI_id = (Double) feature_sEdigeoInput_1_PG
					...
					row2.ORI_id = row_sEdigeoInput_1_PG.ORI_id;
					...
					{ // start of Var scope
						...
						copyOfexport_tmp.ORI_id = row2.ORI_id;
					...
					if (copyOfexport != null) {
						...
						row_sShapefileOutput_1_FI.ORI_id = copyOfexport.ORI_id;
						...
						outFeature_sShapefileOutput_1_SO.setAttribute(
								map_sShapefileOutput_1_SO.get("ORI_id"),
								row_sShapefileOutput_1_FI.ORI_id);
	...
	public static void main(String[] args) {
		final symblim_id symblim_idClass = new symblim_id();

		int exitCode = symblim_idClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = symblim_id.class
					.getClassLoader()
					.getResourceAsStream(
							"drebretagne_geobretagne/symblim_id_0_1/contexts/Default.properties");
			if (inContext != null) {
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = symblim_id.class.getClassLoader()
						.getResourceAsStream(
								"drebretagne_geobretagne/symblim_id_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : symblim_id");
		}
...
/************************************************************************************************
 * 55315 characters generated by Spatial Data Integrator Powered by Talend on
