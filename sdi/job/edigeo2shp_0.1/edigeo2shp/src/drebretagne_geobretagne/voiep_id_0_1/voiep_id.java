...
//
// ============================================================================ 
package drebretagne_geobretagne.voiep_id_0_1;
...
public class voiep_id {
	...
	private final String jobName = "voiep_id";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(voiep_id.this, new Object[] { e,
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread
						...
						+ " présente des erreurs pour l'objet VOIEP_id", "");
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				org.geotools.data.edigeo.EdigeoDataStore store_sEdigeoInput_1_PG = new org.geotools.data.edigeo.EdigeoDataStore(
						context.edigeoDir + "/" + context.fileName, "VOIEP_id");
	...
	public static void main(String[] args) {
		final voiep_id voiep_idClass = new voiep_id();

		int exitCode = voiep_idClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = voiep_id.class
					.getClassLoader()
					.getResourceAsStream(
							"drebretagne_geobretagne/voiep_id_0_1/contexts/Default.properties");
			if (inContext != null) {
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = voiep_id.class.getClassLoader()
						.getResourceAsStream(
								"drebretagne_geobretagne/voiep_id_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : voiep_id");
		}
...
/************************************************************************************************
 * 44336 characters generated by Spatial Data Integrator Powered by Talend on
