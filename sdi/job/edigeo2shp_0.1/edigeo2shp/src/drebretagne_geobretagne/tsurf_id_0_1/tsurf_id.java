...
//
// ============================================================================ 
package drebretagne_geobretagne.tsurf_id_0_1;
...
public class tsurf_id {
	...
	private final String jobName = "tsurf_id";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(tsurf_id.this, new Object[] { e,
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread
						...
						+ " présente des erreurs pour l'objet TSURF_id", "");
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				org.geotools.data.edigeo.EdigeoDataStore store_sEdigeoInput_1_PG = new org.geotools.data.edigeo.EdigeoDataStore(
						context.edigeoDir + "/" + context.fileName, "TSURF_id");
	...
	public static void main(String[] args) {
		final tsurf_id tsurf_idClass = new tsurf_id();

		int exitCode = tsurf_idClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = tsurf_id.class
					.getClassLoader()
					.getResourceAsStream(
							"drebretagne_geobretagne/tsurf_id_0_1/contexts/Default.properties");
			if (inContext != null) {
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = tsurf_id.class.getClassLoader()
						.getResourceAsStream(
								"drebretagne_geobretagne/tsurf_id_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : tsurf_id");
		}
...
/************************************************************************************************
 * 49728 characters generated by Spatial Data Integrator Powered by Talend on
