...
//
// ============================================================================ 
package drebretagne_geobretagne.parcelle_id_0_1;
...
public class parcelle_id {
	...
	private final String jobName = "parcelle_id";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(parcelle_id.this, new Object[] { e,
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread
						...
						+ " présente des erreurs pour l'objet PARCELLE_id", "");
	...
	public static class row_sShapefileOutput_1_FIStruct implements
		...
		public String CODM_id;

		public String getCODM_id() {
			return this.CODM_id;
		}

		public String COAR_id;

		public String getCOAR_id() {
			return this.COAR_id;
		}
		...
		public String INDP_id;

		public String getINDP_id() {
			return this.INDP_id;
		}

		public Double SUPF_id;

		public Double getSUPF_id() {
			return this.SUPF_id;
		}
			...
			synchronized (commonByteArrayLock) {
				...
				try {
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.CODM_id = new String(commonByteArray, 0, length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.COAR_id = new String(commonByteArray, 0, length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.INDP_id = new String(commonByteArray, 0, length);
					}
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.CODM_id == null) {
					dos.writeInt(-1);
				} else {
					byte[] byteArray = this.CODM_id.getBytes();
					dos.writeInt(byteArray.length);
					dos.write(byteArray);
				}
				...
				if (this.COAR_id == null) {
					dos.writeInt(-1);
				} else {
					byte[] byteArray = this.COAR_id.getBytes();
					dos.writeInt(byteArray.length);
					dos.write(byteArray);
				}
				...
				if (this.INDP_id == null) {
					dos.writeInt(-1);
				} else {
					byte[] byteArray = this.INDP_id.getBytes();
					dos.writeInt(byteArray.length);
					dos.write(byteArray);
				}
				...
				if (this.SUPF_id == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeDouble(this.SUPF_id);
				}
		...
		public String toString() {
			...
			sb.append("CODM_id");
			sb.append("=");
			sb.append(String.valueOf(this.CODM_id));

			sb.append(", ");

			sb.append("COAR_id");
			sb.append("=");
			sb.append(String.valueOf(this.COAR_id));
			...
			sb.append("INDP_id");
			sb.append("=");
			sb.append(String.valueOf(this.INDP_id));

			sb.append(", ");

			sb.append("SUPF_id");
			sb.append("=");
			sb.append(String.valueOf(this.SUPF_id));
	...
	public void sEdigeoInput_1_PGProcess(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				attBuilder_sShapefileOutput_1_SO = new org.geotools.feature.AttributeTypeBuilder();
				attBuilder_sShapefileOutput_1_SO.setName("CODM_id");
				attBuilder_sShapefileOutput_1_SO.setBinding(String.class);
				attBuilder_sShapefileOutput_1_SO.setNillable(true);

				ftBuilder_sShapefileOutput_1_SO
						.add(attBuilder_sShapefileOutput_1_SO.buildDescriptor(
								"CODM_id", attBuilder_sShapefileOutput_1_SO
										.buildType()));

				map_sShapefileOutput_1_SO.put("CODM_id", 2);
				attBuilder_sShapefileOutput_1_SO = new org.geotools.feature.AttributeTypeBuilder();
				attBuilder_sShapefileOutput_1_SO.setName("COAR_id");
				attBuilder_sShapefileOutput_1_SO.setBinding(String.class);
				attBuilder_sShapefileOutput_1_SO.setNillable(true);

				ftBuilder_sShapefileOutput_1_SO
						.add(attBuilder_sShapefileOutput_1_SO.buildDescriptor(
								"COAR_id", attBuilder_sShapefileOutput_1_SO
										.buildType()));

				map_sShapefileOutput_1_SO.put("COAR_id", 3);
				attBuilder_sShapefileOutput_1_SO = new org.geotools.feature.AttributeTypeBuilder();
				...
				map_sShapefileOutput_1_SO.put("TEX2_id", 4);
				attBuilder_sShapefileOutput_1_SO = new org.geotools.feature.AttributeTypeBuilder();
				attBuilder_sShapefileOutput_1_SO.setName("INDP_id");
				attBuilder_sShapefileOutput_1_SO.setBinding(String.class);
				attBuilder_sShapefileOutput_1_SO.setNillable(true);

				ftBuilder_sShapefileOutput_1_SO
						.add(attBuilder_sShapefileOutput_1_SO.buildDescriptor(
								"INDP_id", attBuilder_sShapefileOutput_1_SO
										.buildType()));

				map_sShapefileOutput_1_SO.put("INDP_id", 5);
				attBuilder_sShapefileOutput_1_SO = new org.geotools.feature.AttributeTypeBuilder();
				attBuilder_sShapefileOutput_1_SO.setName("SUPF_id");
				attBuilder_sShapefileOutput_1_SO.setBinding(Double.class);
				attBuilder_sShapefileOutput_1_SO.setNillable(true);

				ftBuilder_sShapefileOutput_1_SO
						.add(attBuilder_sShapefileOutput_1_SO.buildDescriptor(
								"SUPF_id", attBuilder_sShapefileOutput_1_SO
										.buildType()));

				map_sShapefileOutput_1_SO.put("SUPF_id", 6);
				attBuilder_sShapefileOutput_1_SO = new org.geotools.feature.AttributeTypeBuilder();
				...
				map_sShapefileOutput_1_SO.put("IDU_id", 7);
				...
				while (reader_sEdigeoInput_1_PG.hasNext()) {
					...
					if (map_sEdigeoInput_1_PG.get("CODM_id") != null) {
						row_sEdigeoInput_1_PG.CODM_id = (String) feature_sEdigeoInput_1_PG
								.getAttribute(map_sEdigeoInput_1_PG
										.get("CODM_id"));
					}
					if (map_sEdigeoInput_1_PG.get("COAR_id") != null) {
						row_sEdigeoInput_1_PG.COAR_id = (String) feature_sEdigeoInput_1_PG
								.getAttribute(map_sEdigeoInput_1_PG
										.get("COAR_id"));
					}
					...
					if (map_sEdigeoInput_1_PG.get("INDP_id") != null) {
						row_sEdigeoInput_1_PG.INDP_id = (String) feature_sEdigeoInput_1_PG
								.getAttribute(map_sEdigeoInput_1_PG
										.get("INDP_id"));
					}
					if (map_sEdigeoInput_1_PG.get("SUPF_id") != null) {
						row_sEdigeoInput_1_PG.SUPF_id = (Double) feature_sEdigeoInput_1_PG
								.getAttribute(map_sEdigeoInput_1_PG
										.get("SUPF_id"));
					}
					...
					row2.CODM_id = row_sEdigeoInput_1_PG.CODM_id;

					row2.COAR_id = row_sEdigeoInput_1_PG.COAR_id;

					row2.TEX2_id = row_sEdigeoInput_1_PG.TEX2_id;

					row2.INDP_id = row_sEdigeoInput_1_PG.INDP_id;

					row2.SUPF_id = row_sEdigeoInput_1_PG.SUPF_id;
					...
					{ // start of Var scope
						...
						copyOfexport_tmp.CODM_id = row2.CODM_id;
						copyOfexport_tmp.COAR_id = row2.COAR_id;
						copyOfexport_tmp.TEX2_id = row2.TEX2_id;
						copyOfexport_tmp.INDP_id = row2.INDP_id;
						copyOfexport_tmp.SUPF_id = row2.SUPF_id;
					...
					if (copyOfexport != null) {
						...
						row_sShapefileOutput_1_FI.CODM_id = copyOfexport.CODM_id;

						row_sShapefileOutput_1_FI.COAR_id = copyOfexport.COAR_id;

						row_sShapefileOutput_1_FI.TEX2_id = copyOfexport.TEX2_id;

						row_sShapefileOutput_1_FI.INDP_id = copyOfexport.INDP_id;

						row_sShapefileOutput_1_FI.SUPF_id = copyOfexport.SUPF_id;
						...
						outFeature_sShapefileOutput_1_SO.setAttribute(
								map_sShapefileOutput_1_SO.get("CODM_id"),
								row_sShapefileOutput_1_FI.CODM_id);

						outFeature_sShapefileOutput_1_SO.setAttribute(
								map_sShapefileOutput_1_SO.get("COAR_id"),
								row_sShapefileOutput_1_FI.COAR_id);
						...
						outFeature_sShapefileOutput_1_SO.setAttribute(
								map_sShapefileOutput_1_SO.get("INDP_id"),
								row_sShapefileOutput_1_FI.INDP_id);

						outFeature_sShapefileOutput_1_SO.setAttribute(
								map_sShapefileOutput_1_SO.get("SUPF_id"),
								row_sShapefileOutput_1_FI.SUPF_id);
				...
				String udigResourceId_sShapefileOutput_1_SO = context.exportDir
						+ "/" + context.fileName + "_parcelle.shp" + "#"
	...
	public static void main(String[] args) {
		final parcelle_id parcelle_idClass = new parcelle_id();

		int exitCode = parcelle_idClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = parcelle_id.class
					.getClassLoader()
					.getResourceAsStream(
							"drebretagne_geobretagne/parcelle_id_0_1/contexts/Default.properties");
			if (inContext != null) {
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = parcelle_id.class.getClassLoader()
						.getResourceAsStream(
								"drebretagne_geobretagne/parcelle_id_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : parcelle_id");
		}
...
/************************************************************************************************
 * 75172 characters generated by Spatial Data Integrator Powered by Talend on
