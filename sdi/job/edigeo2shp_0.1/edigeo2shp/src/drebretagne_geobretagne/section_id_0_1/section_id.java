...
//
// ============================================================================ 
package drebretagne_geobretagne.section_id_0_1;
...
public class section_id {
	...
	private final String jobName = "section_id";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(section_id.this, new Object[] { e,
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread
						...
						+ " présente des erreurs pour l'objet SECTION_id", "");
	...
	public static void main(String[] args) {
		final section_id section_idClass = new section_id();

		int exitCode = section_idClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = section_id.class
					.getClassLoader()
					.getResourceAsStream(
							"drebretagne_geobretagne/section_id_0_1/contexts/Default.properties");
			if (inContext != null) {
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = section_id.class.getClassLoader()
						.getResourceAsStream(
								"drebretagne_geobretagne/section_id_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : section_id");
		}
...
/************************************************************************************************
 * 54550 characters generated by Spatial Data Integrator Powered by Talend on
