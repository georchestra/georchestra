...
//
// ============================================================================ 
package drebretagne_geobretagne.tronfluv_id_0_1;
...
public class tronfluv_id {
	...
	private final String jobName = "tronfluv_id";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(tronfluv_id.this, new Object[] { e,
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread
						...
						+ " présente des erreurs pour l'objet TRONFLUV_id", "");
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String udigResourceId_sShapefileOutput_1_SO = context.exportDir
						+ "/" + context.fileName + "_tronfluv.shp" + "#"
	...
	public static void main(String[] args) {
		final tronfluv_id tronfluv_idClass = new tronfluv_id();

		int exitCode = tronfluv_idClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = tronfluv_id.class
					.getClassLoader()
					.getResourceAsStream(
							"drebretagne_geobretagne/tronfluv_id_0_1/contexts/Default.properties");
			if (inContext != null) {
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = tronfluv_id.class.getClassLoader()
						.getResourceAsStream(
								"drebretagne_geobretagne/tronfluv_id_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : tronfluv_id");
		}
...
/************************************************************************************************
 * 93409 characters generated by Spatial Data Integrator Powered by Talend on
