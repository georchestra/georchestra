...
//
// ============================================================================ 
package drebretagne_geobretagne.subdsect_id_0_1;
...
public class subdsect_id {
	...
	private final String jobName = "subdsect_id";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(subdsect_id.this, new Object[] { e,
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread
						...
						+ " présente des erreurs pour l'objet SUBDSECT_id", "");
	...
	public static class row_sShapefileOutput_1_FIStruct implements
		...
		public String COPL_id;

		public String getCOPL_id() {
			return this.COPL_id;
		}
		...
		public String DRED_id;

		public String getDRED_id() {
			return this.DRED_id;
		}

		public String DEDI_id;

		public String getDEDI_id() {
			return this.DEDI_id;
		}

		public String EOR_id;

		public String getEOR_id() {
			return this.EOR_id;
		}

		public String QUPL_id;

		public String getQUPL_id() {
			return this.QUPL_id;
		}

		public String INP_id;

		public String getINP_id() {
			return this.INP_id;
		}

		public Double ICL_id;

		public Double getICL_id() {
			return this.ICL_id;
		}
			...
			synchronized (commonByteArrayLock) {
				...
				try {
					...
					if (length == -1) {
						...
						this.COPL_id = new String(commonByteArray, 0, length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.DIS_id = new String(commonByteArray, 0, length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.DRED_id = new String(commonByteArray, 0, length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.DEDI_id = new String(commonByteArray, 0, length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.EOR_id = new String(commonByteArray, 0, length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.QUPL_id = new String(commonByteArray, 0, length);
					}
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.INP_id = new String(commonByteArray, 0, length);
					}
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.COPL_id == null) {
					dos.writeInt(-1);
				} else {
					byte[] byteArray = this.COPL_id.getBytes();
				...
				if (this.DIS_id == null) {
					...
					byte[] byteArray = this.DIS_id.getBytes();
					dos.writeInt(byteArray.length);
					dos.write(byteArray);
				}
				...
				if (this.DRED_id == null) {
					dos.writeInt(-1);
				} else {
					byte[] byteArray = this.DRED_id.getBytes();
					dos.writeInt(byteArray.length);
					dos.write(byteArray);
				}
				...
				if (this.DEDI_id == null) {
					dos.writeInt(-1);
				} else {
					byte[] byteArray = this.DEDI_id.getBytes();
					dos.writeInt(byteArray.length);
					dos.write(byteArray);
				}
				...
				if (this.EOR_id == null) {
					...
					byte[] byteArray = this.EOR_id.getBytes();
					dos.writeInt(byteArray.length);
					dos.write(byteArray);
				}
				...
				if (this.QUPL_id == null) {
					dos.writeInt(-1);
				} else {
					byte[] byteArray = this.QUPL_id.getBytes();
					dos.writeInt(byteArray.length);
					dos.write(byteArray);
				}
				...
				if (this.INP_id == null) {
					...
					byte[] byteArray = this.INP_id.getBytes();
					dos.writeInt(byteArray.length);
					dos.write(byteArray);
				}
		...
		public String toString() {
			...
			sb.append("COPL_id");
			sb.append("=");
			sb.append(String.valueOf(this.COPL_id));

			sb.append(", ");

			sb.append("DIS_id");
			sb.append("=");
			sb.append(String.valueOf(this.DIS_id));

			sb.append(", ");

			sb.append("DRED_id");
			sb.append("=");
			sb.append(String.valueOf(this.DRED_id));

			sb.append(", ");

			sb.append("DEDI_id");
			sb.append("=");
			sb.append(String.valueOf(this.DEDI_id));

			sb.append(", ");

			sb.append("EOR_id");
			sb.append("=");
			sb.append(String.valueOf(this.EOR_id));

			sb.append(", ");

			sb.append("QUPL_id");
			sb.append("=");
			sb.append(String.valueOf(this.QUPL_id));

			sb.append(", ");

			sb.append("INP_id");
			sb.append("=");
			sb.append(String.valueOf(this.INP_id));

			sb.append(", ");

			sb.append("ICL_id");
			sb.append("=");
			sb.append(String.valueOf(this.ICL_id));
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				geoAttBuilder_sShapefileOutput_1_SO
						.setBinding(com.vividsolutions.jts.geom.MultiPolygon.class);
				...
				attBuilder_sShapefileOutput_1_SO.setName("COPL_id");
				...
				ftBuilder_sShapefileOutput_1_SO
						.add(attBuilder_sShapefileOutput_1_SO.buildDescriptor(
								"COPL_id", attBuilder_sShapefileOutput_1_SO
										.buildType()));

				map_sShapefileOutput_1_SO.put("COPL_id", 1);
				attBuilder_sShapefileOutput_1_SO = new org.geotools.feature.AttributeTypeBuilder();
				attBuilder_sShapefileOutput_1_SO.setName("DIS_id");
				attBuilder_sShapefileOutput_1_SO.setBinding(String.class);
				attBuilder_sShapefileOutput_1_SO.setNillable(true);

				ftBuilder_sShapefileOutput_1_SO
						.add(attBuilder_sShapefileOutput_1_SO.buildDescriptor(
								"DIS_id", attBuilder_sShapefileOutput_1_SO
										.buildType()));

				map_sShapefileOutput_1_SO.put("DIS_id", 2);
				attBuilder_sShapefileOutput_1_SO = new org.geotools.feature.AttributeTypeBuilder();
				attBuilder_sShapefileOutput_1_SO.setName("DRED_id");
				attBuilder_sShapefileOutput_1_SO.setBinding(String.class);
				attBuilder_sShapefileOutput_1_SO.setNillable(true);

				ftBuilder_sShapefileOutput_1_SO
						.add(attBuilder_sShapefileOutput_1_SO.buildDescriptor(
								"DRED_id", attBuilder_sShapefileOutput_1_SO
										.buildType()));

				map_sShapefileOutput_1_SO.put("DRED_id", 3);
				attBuilder_sShapefileOutput_1_SO = new org.geotools.feature.AttributeTypeBuilder();
				attBuilder_sShapefileOutput_1_SO.setName("DEDI_id");
				attBuilder_sShapefileOutput_1_SO.setBinding(String.class);
				attBuilder_sShapefileOutput_1_SO.setNillable(true);

				ftBuilder_sShapefileOutput_1_SO
						.add(attBuilder_sShapefileOutput_1_SO.buildDescriptor(
								"DEDI_id", attBuilder_sShapefileOutput_1_SO
										.buildType()));

				map_sShapefileOutput_1_SO.put("DEDI_id", 4);
				attBuilder_sShapefileOutput_1_SO = new org.geotools.feature.AttributeTypeBuilder();
				attBuilder_sShapefileOutput_1_SO.setName("EOR_id");
				attBuilder_sShapefileOutput_1_SO.setBinding(String.class);
				attBuilder_sShapefileOutput_1_SO.setNillable(true);

				ftBuilder_sShapefileOutput_1_SO
						.add(attBuilder_sShapefileOutput_1_SO.buildDescriptor(
								"EOR_id", attBuilder_sShapefileOutput_1_SO
										.buildType()));

				map_sShapefileOutput_1_SO.put("EOR_id", 5);
				attBuilder_sShapefileOutput_1_SO = new org.geotools.feature.AttributeTypeBuilder();
				attBuilder_sShapefileOutput_1_SO.setName("QUPL_id");
				attBuilder_sShapefileOutput_1_SO.setBinding(String.class);
				attBuilder_sShapefileOutput_1_SO.setNillable(true);

				ftBuilder_sShapefileOutput_1_SO
						.add(attBuilder_sShapefileOutput_1_SO.buildDescriptor(
								"QUPL_id", attBuilder_sShapefileOutput_1_SO
										.buildType()));

				map_sShapefileOutput_1_SO.put("QUPL_id", 6);
				attBuilder_sShapefileOutput_1_SO = new org.geotools.feature.AttributeTypeBuilder();
				attBuilder_sShapefileOutput_1_SO.setName("INP_id");
				attBuilder_sShapefileOutput_1_SO.setBinding(String.class);
				attBuilder_sShapefileOutput_1_SO.setNillable(true);

				ftBuilder_sShapefileOutput_1_SO
						.add(attBuilder_sShapefileOutput_1_SO.buildDescriptor(
								"INP_id", attBuilder_sShapefileOutput_1_SO
										.buildType()));

				map_sShapefileOutput_1_SO.put("INP_id", 7);
				attBuilder_sShapefileOutput_1_SO = new org.geotools.feature.AttributeTypeBuilder();
				attBuilder_sShapefileOutput_1_SO.setName("ICL_id");
				attBuilder_sShapefileOutput_1_SO.setBinding(Double.class);
				attBuilder_sShapefileOutput_1_SO.setNillable(true);

				ftBuilder_sShapefileOutput_1_SO
						.add(attBuilder_sShapefileOutput_1_SO.buildDescriptor(
								"ICL_id", attBuilder_sShapefileOutput_1_SO
										.buildType()));

				map_sShapefileOutput_1_SO.put("ICL_id", 8);
				attBuilder_sShapefileOutput_1_SO = new org.geotools.feature.AttributeTypeBuilder();
				attBuilder_sShapefileOutput_1_SO.setName("IDU_id");
				attBuilder_sShapefileOutput_1_SO.setBinding(String.class);
				attBuilder_sShapefileOutput_1_SO.setNillable(true);

				ftBuilder_sShapefileOutput_1_SO
						.add(attBuilder_sShapefileOutput_1_SO.buildDescriptor(
								"IDU_id", attBuilder_sShapefileOutput_1_SO
										.buildType()));

				map_sShapefileOutput_1_SO.put("IDU_id", 9);
				...
				while (reader_sEdigeoInput_1_PG.hasNext()) {
					org.opengis.feature.simple.SimpleFeature feature_sEdigeoInput_1_PG = reader_sEdigeoInput_1_PG
							.next();
					if (map_sEdigeoInput_1_PG.get("COPL_id") != null) {
						row_sEdigeoInput_1_PG.COPL_id = (String) feature_sEdigeoInput_1_PG
								.getAttribute(map_sEdigeoInput_1_PG
										.get("COPL_id"));
					}
					if (map_sEdigeoInput_1_PG.get("DIS_id") != null) {
						row_sEdigeoInput_1_PG.DIS_id = (String) feature_sEdigeoInput_1_PG
								.getAttribute(map_sEdigeoInput_1_PG
										.get("DIS_id"));
					}
					if (map_sEdigeoInput_1_PG.get("DRED_id") != null) {
						row_sEdigeoInput_1_PG.DRED_id = (String) feature_sEdigeoInput_1_PG
								.getAttribute(map_sEdigeoInput_1_PG
										.get("DRED_id"));
					}
					if (map_sEdigeoInput_1_PG.get("DEDI_id") != null) {
						row_sEdigeoInput_1_PG.DEDI_id = (String) feature_sEdigeoInput_1_PG
								.getAttribute(map_sEdigeoInput_1_PG
										.get("DEDI_id"));
					}
					if (map_sEdigeoInput_1_PG.get("EOR_id") != null) {
						row_sEdigeoInput_1_PG.EOR_id = (String) feature_sEdigeoInput_1_PG
								.getAttribute(map_sEdigeoInput_1_PG
										.get("EOR_id"));
					}
					if (map_sEdigeoInput_1_PG.get("QUPL_id") != null) {
						row_sEdigeoInput_1_PG.QUPL_id = (String) feature_sEdigeoInput_1_PG
								.getAttribute(map_sEdigeoInput_1_PG
										.get("QUPL_id"));
					}
					if (map_sEdigeoInput_1_PG.get("INP_id") != null) {
						row_sEdigeoInput_1_PG.INP_id = (String) feature_sEdigeoInput_1_PG
								.getAttribute(map_sEdigeoInput_1_PG
										.get("INP_id"));
					}
					if (map_sEdigeoInput_1_PG.get("ICL_id") != null) {
						row_sEdigeoInput_1_PG.ICL_id = (Double) feature_sEdigeoInput_1_PG
								.getAttribute(map_sEdigeoInput_1_PG
										.get("ICL_id"));
					}
					...
					row2.COPL_id = row_sEdigeoInput_1_PG.COPL_id;

					row2.DIS_id = row_sEdigeoInput_1_PG.DIS_id;

					row2.DRED_id = row_sEdigeoInput_1_PG.DRED_id;

					row2.DEDI_id = row_sEdigeoInput_1_PG.DEDI_id;

					row2.EOR_id = row_sEdigeoInput_1_PG.EOR_id;

					row2.QUPL_id = row_sEdigeoInput_1_PG.QUPL_id;

					row2.INP_id = row_sEdigeoInput_1_PG.INP_id;

					row2.ICL_id = row_sEdigeoInput_1_PG.ICL_id;
					...
					{ // start of Var scope
						...
						copyOfexport_tmp.COPL_id = row2.COPL_id;
						copyOfexport_tmp.DIS_id = row2.DIS_id;
						copyOfexport_tmp.DRED_id = row2.DRED_id;
						copyOfexport_tmp.DEDI_id = row2.DEDI_id;
						copyOfexport_tmp.EOR_id = row2.EOR_id;
						copyOfexport_tmp.QUPL_id = row2.QUPL_id;
						copyOfexport_tmp.INP_id = row2.INP_id;
						copyOfexport_tmp.ICL_id = row2.ICL_id;
					...
					if (copyOfexport != null) {
						...
						row_sShapefileOutput_1_FI.COPL_id = copyOfexport.COPL_id;

						row_sShapefileOutput_1_FI.DIS_id = copyOfexport.DIS_id;

						row_sShapefileOutput_1_FI.DRED_id = copyOfexport.DRED_id;

						row_sShapefileOutput_1_FI.DEDI_id = copyOfexport.DEDI_id;

						row_sShapefileOutput_1_FI.EOR_id = copyOfexport.EOR_id;

						row_sShapefileOutput_1_FI.QUPL_id = copyOfexport.QUPL_id;

						row_sShapefileOutput_1_FI.INP_id = copyOfexport.INP_id;

						row_sShapefileOutput_1_FI.ICL_id = copyOfexport.ICL_id;

						row_sShapefileOutput_1_FI.IDU_id = copyOfexport.IDU_id;
						...
						outFeature_sShapefileOutput_1_SO.setAttribute(
								map_sShapefileOutput_1_SO.get("COPL_id"),
								row_sShapefileOutput_1_FI.COPL_id);

						outFeature_sShapefileOutput_1_SO.setAttribute(
								map_sShapefileOutput_1_SO.get("DIS_id"),
								row_sShapefileOutput_1_FI.DIS_id);

						outFeature_sShapefileOutput_1_SO.setAttribute(
								map_sShapefileOutput_1_SO.get("DRED_id"),
								row_sShapefileOutput_1_FI.DRED_id);

						outFeature_sShapefileOutput_1_SO.setAttribute(
								map_sShapefileOutput_1_SO.get("DEDI_id"),
								row_sShapefileOutput_1_FI.DEDI_id);

						outFeature_sShapefileOutput_1_SO.setAttribute(
								map_sShapefileOutput_1_SO.get("EOR_id"),
								row_sShapefileOutput_1_FI.EOR_id);

						outFeature_sShapefileOutput_1_SO.setAttribute(
								map_sShapefileOutput_1_SO.get("QUPL_id"),
								row_sShapefileOutput_1_FI.QUPL_id);

						outFeature_sShapefileOutput_1_SO.setAttribute(
								map_sShapefileOutput_1_SO.get("INP_id"),
								row_sShapefileOutput_1_FI.INP_id);

						outFeature_sShapefileOutput_1_SO.setAttribute(
								map_sShapefileOutput_1_SO.get("ICL_id"),
								row_sShapefileOutput_1_FI.ICL_id);

						outFeature_sShapefileOutput_1_SO.setAttribute(
								map_sShapefileOutput_1_SO.get("IDU_id"),
								row_sShapefileOutput_1_FI.IDU_id);
				...
				String udigResourceId_sShapefileOutput_1_SO = context.exportDir
						+ "/" + context.fileName + "_subdsect.shp" + "#"
	...
	public static void main(String[] args) {
		final subdsect_id subdsect_idClass = new subdsect_id();

		int exitCode = subdsect_idClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = subdsect_id.class
					.getClassLoader()
					.getResourceAsStream(
							"drebretagne_geobretagne/subdsect_id_0_1/contexts/Default.properties");
			if (inContext != null) {
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = subdsect_id.class.getClassLoader()
						.getResourceAsStream(
								"drebretagne_geobretagne/subdsect_id_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : subdsect_id");
		}
...
/************************************************************************************************
 * 85907 characters generated by Spatial Data Integrator Powered by Talend on
 * the January 26, 2010 5:28:52 PM CET
 ************************************************************************************************/
