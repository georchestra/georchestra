...
//
// ============================================================================ 
package drebretagne_geobretagne.subdfisc_id_0_1;
...
public class subdfisc_id {
	...
	private final String jobName = "subdfisc_id";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(subdfisc_id.this, new Object[] { e,
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread
						...
						+ " présente des erreurs pour l'objet SUBDFISC_id", "");
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String udigResourceId_sShapefileOutput_1_SO = context.exportDir
						+ "/" + context.fileName + "_subdfisc.shp" + "#"
	...
	public static void main(String[] args) {
		final subdfisc_id subdfisc_idClass = new subdfisc_id();

		int exitCode = subdfisc_idClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = subdfisc_id.class
					.getClassLoader()
					.getResourceAsStream(
							"drebretagne_geobretagne/subdfisc_id_0_1/contexts/Default.properties");
			if (inContext != null) {
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = subdfisc_id.class.getClassLoader()
						.getResourceAsStream(
								"drebretagne_geobretagne/subdfisc_id_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : subdfisc_id");
		}
...
/************************************************************************************************
 * 44398 characters generated by Spatial Data Integrator Powered by Talend on
