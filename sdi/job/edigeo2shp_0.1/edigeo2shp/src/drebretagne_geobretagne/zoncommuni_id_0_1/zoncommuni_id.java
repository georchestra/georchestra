...
//
// ============================================================================ 
package drebretagne_geobretagne.zoncommuni_id_0_1;
...
public class zoncommuni_id {
	...
	private final String jobName = "zoncommuni_id";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(zoncommuni_id.this, new Object[] { e,
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread
						...
						+ " présente des erreurs pour l'objet ZONCOMMUNI_id",
						"");
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String udigResourceId_sShapefileOutput_1_SO = context.exportDir
						+ "/" + context.fileName + "_zoncommuni.shp" + "#"
	...
	public static void main(String[] args) {
		final zoncommuni_id zoncommuni_idClass = new zoncommuni_id();

		int exitCode = zoncommuni_idClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = zoncommuni_id.class
					.getClassLoader()
					.getResourceAsStream(
							"drebretagne_geobretagne/zoncommuni_id_0_1/contexts/Default.properties");
			if (inContext != null) {
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = zoncommuni_id.class.getClassLoader()
						.getResourceAsStream(
								"drebretagne_geobretagne/zoncommuni_id_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : zoncommuni_id");
		}
...
/************************************************************************************************
 * 93452 characters generated by Spatial Data Integrator Powered by Talend on
 * the January 26, 2010 5:28:55 PM CET
 ************************************************************************************************/
