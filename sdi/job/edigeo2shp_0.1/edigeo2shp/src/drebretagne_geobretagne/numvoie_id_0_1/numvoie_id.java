...
//
// ============================================================================ 
package drebretagne_geobretagne.numvoie_id_0_1;
...
public class numvoie_id {
	...
	private final String jobName = "numvoie_id";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(numvoie_id.this, new Object[] { e,
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread
						...
						+ " présente des erreurs pour l'objet NUMVOIE_id", "");
				talendLogs_LOGS.addMessage("tWarn", "tWarn_1", 4, "Le fichier "
						+ context.fileName
						+ " présente des erreurs pour l'objet NUMVOIE_id", 42);
				talendLogs_LOGSProcess(globalMap);
	...
	public static void main(String[] args) {
		final numvoie_id numvoie_idClass = new numvoie_id();

		int exitCode = numvoie_idClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = numvoie_id.class
					.getClassLoader()
					.getResourceAsStream(
							"drebretagne_geobretagne/numvoie_id_0_1/contexts/Default.properties");
			if (inContext != null) {
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = numvoie_id.class.getClassLoader()
						.getResourceAsStream(
								"drebretagne_geobretagne/numvoie_id_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : numvoie_id");
		}
...
/************************************************************************************************
 * 67507 characters generated by Spatial Data Integrator Powered by Talend on
