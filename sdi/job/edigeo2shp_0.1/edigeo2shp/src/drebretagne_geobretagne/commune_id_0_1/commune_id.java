...
//
// ============================================================================ 
package drebretagne_geobretagne.commune_id_0_1;
...
public class commune_id {
	...
	private final String jobName = "commune_id";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(commune_id.this, new Object[] { e,
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				resumeUtil.addLog("USER_DEF_LOG", "NODE:tWarn_1", "", Thread
						...
						+ " présente des erreurs pour l'objet COMMUNE_id", "");
	...
	public static void main(String[] args) {
		final commune_id commune_idClass = new commune_id();

		int exitCode = commune_idClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = commune_id.class
					.getClassLoader()
					.getResourceAsStream(
							"drebretagne_geobretagne/commune_id_0_1/contexts/Default.properties");
			if (inContext != null) {
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = commune_id.class.getClassLoader()
						.getResourceAsStream(
								"drebretagne_geobretagne/commune_id_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : commune_id");
		}
...
/************************************************************************************************
 * 54067 characters generated by Spatial Data Integrator Powered by Talend on
 * the January 26, 2010 5:28:49 PM CET
 ************************************************************************************************/
