...
It features a **metadata catalog** (GeoNetwork 2.9-pre), an **OGC server** (GeoServer 2.3.1), an **advanced viewer**, an **extractor** and **many more** (security and auth system based on proxy/CAS/LDAP, analytics, admin UIs, ...)
