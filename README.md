 ...
 * you could also use the [generic wars](http://packages.georchestra.org/bot/wars/16.12/) with their "[datadir](https://github.com/georchestra/datadir)", as an alternate method. The above packages provide both.
