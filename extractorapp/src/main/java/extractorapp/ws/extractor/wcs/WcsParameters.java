...
/**
 * The {@link Format} / {@link GridCoverageReader} API requires that there are ParameterObjects defined that can be used for
 * configuring read requests with {@link GridCoverageReader}.  This class contains all the parameters that possible
 * 
 * This should not need to be used directory, instead the {@link WcsReaderRequest} class should be used as it can
 * translate to and from these parameters in a easier way.
 * 
 * Read the description parameter of the parameters for documentation on what they do.
 * 
 * @author jeichar
 */
...
class WcsParameters {
    ...
    public static final DefaultParameterDescriptor<Integer> WIDTH = DefaultParameterDescriptor.create ("width", "Width in pixels of map picture. One of WIDTH/HEIGHT or RESX/Y is required.", Integer.class, null, false);
    public static final DefaultParameterDescriptor<Integer> HEIGHT = DefaultParameterDescriptor.create ("height", "Height in pixels of map picture. One of WIDTH/HEIGHT or RESX/Y is required.", Integer.class, null, false);
    
    public static final DefaultParameterDescriptor<Double> TIME1 = DefaultParameterDescriptor.create ("time1", "start time", Double.class, null, false);
    public static final DefaultParameterDescriptor<Double> TIME2 = DefaultParameterDescriptor.create ("time2", "end time", Double.class, null, false);
    
    public static final DefaultParameterDescriptor<Double> MINX = DefaultParameterDescriptor.create ("minx", "minx of the bbox", Double.class, null, false);
    public static final DefaultParameterDescriptor<Double> MINY = DefaultParameterDescriptor.create ("miny", "miny of the bbox", Double.class, null, false);
    public static final DefaultParameterDescriptor<Double> MAXX = DefaultParameterDescriptor.create ("maxx", "maxx of the bbox", Double.class, null, false);
    ...
    public static final ParameterDescriptorGroup TIME = new WcsParameterDescriptorGroup ("time", new GeneralParameterDescriptor[]{
            TIME1, TIME2,
    });
    public static final ParameterDescriptorGroup EXTENT = new WcsParameterDescriptorGroup ("extent", new GeneralParameterDescriptor[]{
            BBOX, TIME
    });
    
    public static final ParameterDescriptorGroup SIZE = new WcsParameterDescriptorGroup ("size", new GeneralParameterDescriptor[]{
            WIDTH, HEIGHT,
    });
    public static final ParameterDescriptorGroup RES = new WcsParameterDescriptorGroup ("res", new GeneralParameterDescriptor[]{
            RESX, RESY,
    });
    public static final ParameterDescriptorGroup RESULT_IMAGE_PARAMS = new WcsParameterDescriptorGroup ("imgParams", new GeneralParameterDescriptor[]{
            SIZE, RES
    });

    public static final ParameterDescriptorGroup ROOT = new WcsParameterDescriptorGroup ("rootGroup", new GeneralParameterDescriptor[] {
            VERSION, COVERAGE, CRS,
            EXTENT, RESULT_IMAGE_PARAMS, FORMAT, USE_POST
    });
