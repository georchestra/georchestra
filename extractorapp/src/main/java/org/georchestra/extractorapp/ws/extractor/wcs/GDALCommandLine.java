...
class GDALCommandLine {
    ...
    static void gdalTransformation(File sourceFile, File file, WcsReaderRequest executedRequest,
    ...
    private static void transformFormat(File sourceFile, WcsReaderRequest executedRequest,
            WcsReaderRequest targetRequest, File outFile) throws IOException {
    ...
    private static void reproject(File sourceFile, WcsReaderRequest executedRequest, WcsReaderRequest targetRequest,
        ...
        try {
            ...
            if (exitCode != 0) {
                throw new ExtractorException(
                        command.toString() + " failed. Output is as follows:\n" + gdalOutput.toString());
            }
