...
public class BBoxWriterTest {
	...
	/**
	 * Test method for {@link org.georchestra.extractorapp.ws.extractor.BBoxWriter#generateFiles()}.
	 */
	@Test
	...
	private void testBBox( FileFormat format) throws Exception{
		...
		ReferencedEnvelope bbox = new ReferencedEnvelope(227532.435762, 260426.450558, 6704235.126328, 6768637.529969, crs);
