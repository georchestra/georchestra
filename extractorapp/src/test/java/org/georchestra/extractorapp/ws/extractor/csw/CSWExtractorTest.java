...
public class CSWExtractorTest extends AbstractTestWithServer {
    ...
    public void testCheckPermission_no_auth_permitted() throws Exception {
        new CSWExtractor(folder.getRoot(), null, null, "localhost", null)
                .checkPermission(createExtractionRequest(MD_UUID), null, "localhost");
    ...
    public void testCheckPermission_no_auth_denied() throws Exception {
        new CSWExtractor(folder.getRoot(), null, null, "localhost", null)
                .checkPermission(createExtractionRequest(DENIED_UUID), null, "localhost");
    ...
    public void testCheckPermission_no_auth_denied2() throws Exception {
        new CSWExtractor(folder.getRoot(), null, null, "localhost", null)
                .checkPermission(createExtractionRequest(EMPTY_UUID), null, "localhost");
    ...
    public void testCheckPermission_auth() throws Exception {
        ...
        setServerContext(CONTEXT, new HttpHandler() {
            ...
            public void handle(HttpExchange httpExchange) throws IOException {
                ...
                if (authorization != null && authorization.equals("Basic " + authStringEnc)
        ...
        new CSWExtractor(folder.getRoot(), username, password, "localhost", null)
                .checkPermission(createExtractionRequest(MD_UUID), impUser, "localhost");
        assertTrue(serverWasCalled);
    }
    ...
    private void respondWithEmptyMetadataDocument(HttpExchange httpExchange) throws IOException {
        byte[] response = TestResourceUtils.getResourceAsBytes(CSWExtractorTest.class, "/csw/csw-GetById-Empty.xml");
        writeResponse(httpExchange, response);
    }
    ...
    private ExtractorLayerRequest createExtractionRequest(String mdUuid)
        ...
        layerJson.put(ExtractorLayerRequest.ISO_METADATA_URL_KEY,
