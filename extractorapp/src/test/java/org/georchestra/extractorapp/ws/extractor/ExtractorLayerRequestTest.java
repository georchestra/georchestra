...
public class ExtractorLayerRequestTest {
	...
	public void testExtractorLayerRequest() throws Exception{
		...
		JSONObject configJson= new JSONObject("{\"emails\":[\""+email+"\"],"+
			"\"globalProperties\":{\"projection\":\""+projection+"\",\"resolution\":"+resolution+",\"rasterFormat\":\""+format+"\",\"vectorFormat\":\"shp\",\"bbox\":{\"srs\":\"EPSG:2154\",\"value\":[500000,6870000,800000,7110000]}}," +
			"\"layers\":[{\"projection\":\"EPSG:2154\",\"resolution\":null,\"format\":\""+format+"\",\"bbox\":{\"srs\":\"CRS:84\",\"value\":[2.0774392511928,50.025833789344,2.0813661495014,50.028618317235]},\"owsUrl\":\""+owsUrl+"\",\"owsType\":\""+owsType+"\",\"layerName\":\""+layerName+"\"}]}");
