...
public class TestResourceUtils {
	 ...
	 *
	 * @param testClass    the class to use as the reference class for loading the
	 *                     resource
	 * @param resourceName name of the resource, If the name starts with / then the
	 *                     resources is relative to the root of the classpath
	 *                     otherwise the resource is relative to the package of the
	 *                     testclass
	 */
