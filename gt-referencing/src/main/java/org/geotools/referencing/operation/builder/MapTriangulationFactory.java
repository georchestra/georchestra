 ...
 *
 * @since 2.4
 * @source $URL: http://svn.osgeo.org/geotools/tags/2.7.4/modules/library/referencing/src/main/java/org/geotools/referencing/operation/builder/MapTriangulationFactory.java $
 * @version $Id: MapTriangulationFactory.java 30641M 2012-05-23 14:03:36Z (local) $
 * @author Jan Jezek
 */
