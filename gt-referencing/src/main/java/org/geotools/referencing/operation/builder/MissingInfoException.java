 ...
 *
 *
 * @source $URL: http://svn.osgeo.org/geotools/tags/2.7.4/modules/library/referencing/src/main/java/org/geotools/referencing/operation/builder/MissingInfoException.java $
 * @version $Id: MissingInfoException.java 37299M 2012-05-23 14:03:36Z (local) $
 * @author Jan Jezek
 *
 */
