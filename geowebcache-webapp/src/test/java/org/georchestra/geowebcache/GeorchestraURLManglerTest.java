...
public class GeorchestraURLManglerTest {
    ...
    public void testGeorchestraURLMangler() {
        GeorchestraURLMangler gum =
                new GeorchestraURLMangler("http://sdi.georchestra.org", "geowebcache");

        String finalUrl =
                gum.buildURL("http://localhost:8080", "geowebcache-private", "/service/wmts");
        ...
        finalUrl =
                gum.buildURL(
                        "http://localhost:8080////", "/geowebcache-private/", "///service/wmts///");
        ...
        gum =
                new GeorchestraURLMangler(
                        "////https://sdi.georchestra.org:8443////", "////geo/web/cache/////");
        finalUrl =
                gum.buildURL(
                        "http://localhost:8080////", "/geowebcache-private/", "///service/wmts///");
        assertTrue(
                finalUrl.equals("https://sdi.georchestra.org:8443/geo/web/cache/service/wmts///"));
    }
}
