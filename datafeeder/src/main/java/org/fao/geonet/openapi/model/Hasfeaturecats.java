...
public class Hasfeaturecats {
    @JsonProperty("item")
    private List<RelatedMetadataItem> item = null;

    public Hasfeaturecats item(List<RelatedMetadataItem> item) {
        this.item = item;
        return this;
    }

    public Hasfeaturecats addItemItem(RelatedMetadataItem itemItem) {
        if (this.item == null) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        Hasfeaturecats hasfeaturecats = (Hasfeaturecats) o;
        return Objects.equals(this.item, hasfeaturecats.item);
    }
    ...
    public String toString() {
        ...
        sb.append("class Hasfeaturecats {\n");
