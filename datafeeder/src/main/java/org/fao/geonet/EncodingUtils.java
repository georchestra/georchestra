...
public final class EncodingUtils {
    ...
    /**
     * <p>
     * Encodes a collection of query parameters according to the Swagger collection
     * format.
     * </p>
     *
     * <p>
     * Of the various collection formats defined by Swagger ("csv", "tsv", etc),
     * Feign only natively supports "multi". This utility generates the other format
     * types so it will be properly processed by Feign.
     * </p>
     *
     * <p>
     ...
     * </p>
     * 
     * @param parameters       The collection object to be formatted. This object
     *                         will not be changed.
     * @param collectionFormat The Swagger collection format (eg, "csv", "tsv",
     *                         "pipes"). See the <a href=
