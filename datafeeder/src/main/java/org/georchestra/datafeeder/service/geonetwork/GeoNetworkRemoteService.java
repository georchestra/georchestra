...
public class GeoNetworkRemoteService {
    ...
    public GeoNetworkRemoteService(@NonNull URL geonetworkApiURL) {
        this.apiURL = geonetworkApiURL;

    }

    public String publish(@NonNull Supplier<String> xmlRecordAsString) {
