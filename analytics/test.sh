...
#curl -H "Content-Type: application/json" -X POST \
#-d '{"service":"combinedRequests","startDate":"2016-10-26","endDate":"2016-10-27","group":"MOD_ANALYTICS"}' \
#http://localhost:8280/analytics/ws/combinedRequests

#curl -H "Content-Type: application/json" -X POST \
#-d '{"service":"layersUsage","startDate":"2016-10-22","endDate":"2016-12-28","_group":"MOD_EXTRACTORAPP","limit":20}' \
#http://localhost:8280/analytics/ws/layersUsage

#curl -H "Content-Type: application/json" -X POST \
#-d '{"service":"combinedRequests","startDate":"2016-10-21","endDate":"2016-10-28"}' \
#http://localhost:8280/analytics/ws/distinctUsers
