...
Analytics.Lang.en = {
    ...
    "Personalized extractions":"Personalized extractions",
    "Downloads from GeoNetwork":"Downloads from GeoNetwork",
    "Select this tab to access the statistics of the downloads catalog":"Select this tab to access the statistics of the downloads catalog",   
    ...
    "Records N0 to N1 of N2":"Records {0} to {1} of {2}",
