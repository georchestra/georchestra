...
Analytics.Lang.fr = {
    ...
    "Request": "Requête",
    "Metadata": "Métadonnée",
    "from service": " du service ",
    "OGC Service": "Service OGC",
    ...
    "Personalized extractions": "Extractions personnalisées",
    "Downloads from GeoNetwork": "Téléchargements depuis GeoNetwork",
    "Select this tab to access the statistics of downloads from the catalog": "Sélectionnez cet onglet pour accéder aux statistiques des téléchargements de fichiers depuis le catalogue",   
    ...
    "Select this tab to access the OGC service statistics": "Sélectionnez cet onglet pour accéder aux statistiques des services OGC de la plateforme",
    ...
    "Latest users who downloaded the OWSTYPE layer": "Utilisateurs ayant téléchargé la couche ${OWSTYPE}",
    ...
    "from metadata": "de la métadonnée",
    "Records N0 to N1 of N2": "Enregistrements {0} à {1} sur {2}",
