...
public class PointSymbolizerFactory implements I_SymbolizerFactory {
    ...
    /**
     * Iterator to access Symbolizer objects created by this PointSymbolizerFactory
     * <br />
     ...
     * number of classes. Those sizes will be used to create PointSymbolizer
     * accessible via the {@link PointSymbolizerFactory#iterator()}<br />
     ...
     * {@link PointSymbolizerFactory#PointSymbolizerFactory(int, Color, Color)}
     * <br />
