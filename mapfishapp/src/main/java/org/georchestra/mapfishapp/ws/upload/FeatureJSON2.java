...
final class FeatureJSON2 extends FeatureJSON {
	 ...
	 * <p>
	 * Setting the target feature type will help the geojson parser determine the
	 * type of feature properties during properties. When the type is not around all
	 * properties are returned as a string.
	 * </p>
	 *
	 ...
	 * <p>
	 * When set each feature object will contain a "bbox" attribute whose value is
	 * an array containing the elements of the bounding box (in x1,y1,x2,y2 order)
	 * of the feature
	 * </p>
	 */
	 ...
	 * <p>
	 * When set the feature collection object will contain a "bbox" attribute whose
	 * value is an array containing elements of the bounding box (in x1,y1,x2,y2
	 * order) of the feature collection.
	 * </p>
	 */
	...
	/**
	 * Sets the flag controlling whether feature coordinate reference systems are
	 * encoded.
	 *
	...
	/**
	 * The flag controlling whether feature collection coordinate reference systems
	 * are encoded.
	 * <p>
	 * When set the feature collection object will contain a "crs" attribute
	 * describing the coordinate reference system of the feature collection.
	 * </p>
	 */
	 ...
	 * <p>
	 * When set, properties with null values are encoded as null in the GeoJSON
	 * document.
	 * </p>
	 */
	 ...
	 * @return The feature.
	 *
	 * @throws IOException In the event of a parsing error or if the input json is
	 *                     invalid.
	 */
	public SimpleFeature readFeature(Object input) throws IOException {
		return GeoJSONUtil.parse(
				new FeatureHandler(featureType != null ? new SimpleFeatureBuilder(featureType) : null, attio), input,
				false);
	}
...
//          }
	 ...
	 * <p>
	 * Warning that this method will load the entire feature collection into memory.
	 * For large feature collections {@link #streamFeatureCollection(Object)} should
	 * be used.
	 * </p>
	 *
	 * @param input The input. See {@link GeoJSONUtil#toReader(Object)} for details.
...
//    }
	...
	/**
	 * Reads a feature collection from GeoJSON streaming back the contents via an
	 * iterator.
	 *
	 * @param input The input. See {@link GeoJSONUtil#toReader(Object)} for details.
	 *
	 ...
	 * <p>
	 * This method calls through to
	 * {@link #writeCRS(CoordinateReferenceSystem, Object)}
	 * </p>
	 * 
	 * @param crs    The coordinate reference system.
	 * @param output The output stream.
