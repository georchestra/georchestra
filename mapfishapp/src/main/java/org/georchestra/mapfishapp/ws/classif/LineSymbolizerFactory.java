...
public class LineSymbolizerFactory implements I_SymbolizerFactory {
    ...
    /**
     * Iterator to access Symbolizer objects created by this LineSymbolizerFactory
     * <br />
    ...
    /**
     * Interpolates sizes between an interval set by minSize and maxsize given the
     * number of classes. Those sizes will be used to create LineSymbolizer
     * accessible via the {@link LineSymbolizerFactory#iterator()}<br />
    ...
    /**
     * Gets the iterator to access the created LineSymbolizer objects. Its size can
     * inferred from the number of classes passed by argument in
     * {@link LineSymbolizerFactory#LineSymbolizerFactory(int, Color, Color)} or the
     * size in {@link LineSymbolizerFactory#LineSymbolizerFactory(int, int)}
     */
    ...
    /**
     * Get colors. Get interpolated colors if created with
