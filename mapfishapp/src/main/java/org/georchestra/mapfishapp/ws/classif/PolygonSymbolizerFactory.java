...
public class PolygonSymbolizerFactory implements I_SymbolizerFactory {
    ...
    /**
     * Iterator to access Symbolizer objects created by this
     * PolygonSymbolizerFactory <br />
    ...
    /**
     * Gets the iterator to access the created PolygonSymbolizer objects. Its size
     * can inferred from the number of classes passed by argument in
     * {@link PolygonSymbolizerFactory#PolygonSymbolizerFactory(int, Color, Color)}
     * or the size in
