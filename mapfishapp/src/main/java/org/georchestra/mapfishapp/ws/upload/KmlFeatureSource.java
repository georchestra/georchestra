...
class KmlFeatureSource {
    ...
    private Configuration getConfig(File f) throws IOException, UnsupportedGeofileFormatException {
        ...
        try {
            ...
            // it the configuration property was not set in the parse process the file is
            // not recognized.
     ...
     * <p>
     * This process will set the kml configuration property taking into account the
     * file version.
     * </p>
     * 
     * @return
