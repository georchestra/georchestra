...
OpenLayers.Lang.es = OpenLayers.Util.extend(OpenLayers.Lang.es, {
    ...
    "Download layer": "Descargar la capa",
    "Extract data": "Extraer los datos",
    ...
    "... or a local context": "... o un mapa local",
    "Load or add the layers from one of these map contexts:": "Remplazar la composición actual del mapa por una de estas mapas :",
    "A unique OSM layer": "Una capa OpenStreetMap única",
    "default viewer context": "mapa por omisión",
    "(default)": "<br/>(mapa por omisión)",
    ...
    "My contexts": "Mis mapas",
    "Created": "Creación",
    "Accessed": "Accedido",
    "Count": "Acceso",
    "View": "Visualizar",
    "View the selected context": "Visualizar el mapa seleccionada (ojo : remplazará el mapa actuale)",
    "Download": "Descargar",
    ...
    "Context restoring": "Restaurando el mapa",
