...
OpenLayers.Control.Bookmark = OpenLayers.Class(OpenLayers.Control, {
    ...
    add: function(label, bounds, func, param) {
      ...
      this.stack.push({"label":label.toUpperCase(),"bounds":bounds, "func": func, "param": param});
      this.stackState = true;
      this.redraw();
      return true;
    },
    ...
    onBookmarkClick: function(e) {
         switch(this.action) {
            ...
            case "zoom":
            default:
               this.bookmark.zoomTo(this.label);
               break
         }
        OpenLayers.Event.stop(e);
    },
...
OpenLayers.Control.Bookmark.VERSION_NUMBER = '1.0';