...
public class MockConnectionPool extends ConnectionPool {
    ...
    public Connection getConnection() throws SQLException {
        ...
        Mockito.when(mockedConnection
                .prepareStatement("INSERT INTO mapfishapp.geodocs (username, standard, raw_file_content, "
                        + "file_hash) VALUES (?,?,?,?);"))
        ...
        Mockito.when(
                mockedConnection.prepareStatement("UPDATE mapfishapp.geodocs set last_access = now() , access_count = "
