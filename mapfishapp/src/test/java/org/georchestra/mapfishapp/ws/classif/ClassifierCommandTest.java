...
public class ClassifierCommandTest {
	...
	public void testChoropleths() throws Exception {
		...
		JSONObject jsReq = new JSONObject().put("type", "CHOROPLETHS").put("wfs_url", wfsUrl)
				...
				.put("first_color", firstColor).put("symbol_type", "point").put("last_color", lastColor);
	...
	public void testUniqueValues() throws Exception {
		...
		JSONObject jsReq = new JSONObject().put("type", "UNIQUE_VALUES").put("wfs_url", wfsUrl)
				.put("layer_name", featureTypeName).put("attribute_name", propertyName).put("palette", paletteID)
	...
	public void testUnknownClassificationType() throws Exception {
		...
		JSONObject jsReq = new JSONObject().put("type", "WRONGTYPE").put("wfs_url", wfsUrl)
				.put("layer_name", featureTypeName).put("attribute_name", propertyName);
