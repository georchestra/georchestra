...
public class ContextControllerTest {
	...
	public void testGetXmlInfo() throws Exception {
		...
		assertTrue("Unexpected tip",
				jsRet.get("tip").equals("This is the default context provided for geOrchestra, loading a layer "
						+ "kindly provided by GéoBretagne, data issued from OpenStreetMap and contributors"));
		assertTrue("Unexpected keywords: does not contain \"OSM\"",
				jsRet.getJSONArray("keywords").toString().contains("OSM"));
		assertTrue("Unexpected keywords: does not contain \"Géobretagne\"",
				jsRet.getJSONArray("keywords").toString().contains("Géobretagne"));
	...
	/**
	 * This test ensures that the retrieved contexts are correctly sorted in
	 * alphabetical order.
	 *
	 * @throws Exception
	 */
