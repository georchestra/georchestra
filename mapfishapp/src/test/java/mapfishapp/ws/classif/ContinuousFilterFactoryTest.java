...
import mapfishapp.ws.classif.ContinuousFilterFactory.Interval;
...
public class ContinuousFilterFactoryTest {
    ...
    public void testIntervalCount() {
        ...
        int classCount = 3;
        ArrayList<Double> values = new ArrayList<Double>(Arrays.asList(new Double[] 
                                  {2.0, 7.0, 6.0, 6.0, 3.0, -2.0, 0.0, 34.0, 1.0, -3.0, -6.0, 3.0, 10.0, 6.0 }
                                ));
    ...
    public void testIntervals() {
        int classCount = 3;
        ArrayList<Double> values = new ArrayList<Double>(Arrays.asList(new Double[] 
                                  {2.0, 1.0, -3.0, -6.0, 3.0, 10.0, 6.0, 7.0, 6.0, 6.0, 3.0, -2.0, 0.0, 34.0}
                                ));
        ContinuousFilterFactory cff = new ContinuousFilterFactory(values, classCount, "foo");
