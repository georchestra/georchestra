...
public class EmailControllerTest {
    ...
    public void testSubjectPresent()
        ...
        try {
            ...
            Assertions.assertEquals("No subject specified, 'subject' field is required", ex.getMessage());
        }
    }
    ...
    public void testSubjectTooLong()
        ...
        try {
            ...
            Assertions.assertEquals("Subject is too long, it should not exceed 200 bytes", ex.getMessage());
        }
    }
    ...
    public void testBodyPresent()
        ...
        try {
            ...
            Assertions.assertEquals("No body specified, 'body' field is required", ex.getMessage());
        }
    }
    ...
    public void testBodyTooLong()
        ...
        try {
            ...
            Assertions.assertEquals("Body is too long, it should not exceed 10000 bytes", ex.getMessage());
        }
    }
    ...
    public void testNoRecipient()
        ...
        try {
            ...
            Assertions.assertEquals("One of 'to', 'cc' or 'bcc' must be present in request", ex.getMessage());
        }
    ...
    public void testRecipientSize()
        ...
        try {
            ...
            Assertions.assertEquals("Too many recipient in request, max recipient : 10", ex.getMessage());
        }
    }
    ...
    public void testRecipientAgainstWhitelist()
        ...
        try {
            ...
            Assertions.assertEquals("Recipient not allowed : psc-noexist@georchestra.org", ex.getMessage());
        }
    }
    ...
    public void testRecipientAgainstLdap()
        ...
        try {
            ...
            Assertions.assertEquals("Recipient not allowed : adresse-tata@georchestra.org", ex.getMessage());
        }
    }
