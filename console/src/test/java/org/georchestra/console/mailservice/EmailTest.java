...
public class EmailTest {
	...
	public void doSetUp() {
		...
		Mockito.when(this.georchestraConfiguration.getProperty(Mockito.eq("publicUrl"))).thenReturn(this.publicUrl);
	}
	...
	public void testUTF8EmailEncoding() throws MessagingException, IOException {
		Email email = new Email(recipients, "Compte créé", smtpHost, smtpPort, false, replyTo, from, "UTF-8", "UTF-8",
				"UTF-8", this.utf8Template, this.servletContext, this.georchestraConfiguration);
	...
	public void testLatinEmailEncoding() throws IOException, MessagingException {
		Email email = new Email(recipients, "Compte créé", smtpHost, smtpPort, false, replyTo, from, "UTF-8", "UTF-8",
				"ISO-8859-15", this.isoTemplate, this.servletContext, this.georchestraConfiguration);
	...
	public void testReplace() throws IOException, MessagingException {
		Email email = new Email(recipients, "Compte créé", smtpHost, smtpPort, false, replyTo, from, "UTF-8", "UTF-8",
				"ISO-8859-15", this.replaceTemplate, this.servletContext, this.georchestraConfiguration);
