...
public class FileUtilsTest {
    ...
    public void testDelete() throws IOException {
        ...
        File testDelete = newFile(folder, "testDelete");
    ...
    public void testZipDirBadParameters() throws Exception {
        File zipf = newFile(folder, "test.zip");
    ...
    public void testArchiveToZip() throws Exception {
        ...
        File z = newFile(folder, "test.zip");
    ...
    public void testToSafeFileName() {
        String[] testedPaths = new String[] { "../../../../../../../etc/passwd", "soundslegitAsFilename",
                "C:\\windows\\system32\\kernel32.dll", "some<>inconvient***Characters\\\\///" };
        String[] expectedOutputPaths = new String[] { ".._.._.._.._.._.._.._etc_passwd", "soundslegitAsFilename",
                "C__windows_system32_kernel32.dll", "some__inconvient___Characters_____" };
