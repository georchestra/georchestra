...
public class Email {
    ...
    public Email(String[] recipients, String emailSubject, String smtpHost, int smtpPort, boolean emailHtml,
            String replyTo, String from, String bodyEncoding, String subjectEncoding, String templateEncoding,
            String fileTemplate, ServletContext servletContext, GeorchestraConfiguration georConfig) {
    ...
    public String toString() {
        return "Email{" + "smtpHost='" + smtpHost + '\'' + ", smtpPort=" + smtpPort + ", emailHtml='" + emailHtml + '\''
                ...
                + ", subjectEncoding='" + subjectEncoding + '\'' + ", recipients=" + Arrays.toString(recipients)
