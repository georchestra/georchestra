...
GEOR.custom = {
     ...
     */
    GEOSERVER_WMS_URL: "http://test.geobretagne.fr/geoserver/wms",

    /**
     * Constant: GEOSERVER_WFS_URL
     * The URL to GeoServer WFS.
     */
    GEOSERVER_WFS_URL: "http://test.geobretagne.fr/geoserver/wfs",
     ...
     */
    BASE_LAYER_NAME: "geob_loc:limites_administratives",
    ...
    STARTUP_SERVICES: [
        {
            text: "GeoBretagne loc",
            owstype: "WMS",
            owsurl: "http://test.geobretagne.fr/geoserver/geob_loc/wms"
        }
    ],
