...
public class AtlasMailComponent {
	...
	public void init() {
		...
		if ((georConfiguration != null) && (georConfiguration.activated())) {
			...
			vProp.setProperty("file.resource.loader.class",
					"org.apache.velocity.runtime.resource.loader.FileResourceLoader");
			vProp.setProperty("file.resource.loader.path",
					georConfiguration.getContextDataDir() + File.separator + "emails");
			...
			vProp.setProperty("class.resource.loader.class",
	...
	public String formatMail(AtlasJob job) {
		...
		mail = VelocityEngineUtils.mergeTemplateIntoString(this.velocityEngine, this.successTemplatePath, "UTF-8",
				model);
