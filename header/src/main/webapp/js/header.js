var menu = [
    {id: 'geonetwork', name: 'catalogue', url: '/geonetwork/apps/georchestra/'},
    {id: 'mapfishapp', name: 'Visualiseur', url: '/mapfishapp/'},
    {id: 'extractorapp', name: 'Extractor', url: '/extractorapp/'},
    {id: 'geoserver', name: 'Services', url: '/geoserver/web/'},
];
var active;
